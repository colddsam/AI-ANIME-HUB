      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <FadeIn direction="right" delay={0.2}>
            <TextReveal text={product.title} element="h1" className="text-3xl font-bold text-[#fdeff0] mb-2" />
          ...
          <TabsContent value="description" className="bg-[#2a2642]/50 p-6 rounded-lg">
            <FadeIn>
              ...
              <p className="text-[#fdeff0]/80 mb-4">
                ...
                aesthetic to your digital devices. The 4K resolution ensures crisp, clear details even on large
                displays.
              </p>
        ...
        <div className="mb-16">
          <Parallax direction="up" speed={0.2}>
