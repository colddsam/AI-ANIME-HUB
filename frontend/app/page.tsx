    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#393459]/90 flex flex-col items-center justify-center text-center px-4">
          <TextReveal
            text="Where AI Meets Anime Dreams"
            element="h1"
          ...
          <StaggerChildren delay={0.8} staggerDelay={0.15}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {categories.map((category) => (
                <StaggerItem key={category.title}>
                  <Link
                    href={category.href}
                    className="group relative h-64 overflow-hidden rounded-lg transition-transform hover:scale-[1.02] block"
                  >
                    <Image
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-[#393459] to-[#ff5a7e]/30">
        <ScrollZoom>
          <div className="container mx-auto text-center">
            <Parallax direction="up" speed={0.3}>
      ...
      {/* Floating CTA */}
      <FloatingElement className="fixed bottom-6 right-6 z-50" duration={3} yOffset={10}>
        <div className="bg-[#ff5a7e] text-white px-4 py-3 rounded-full shadow-lg flex items-center gap-2">
